    ...
    <section className="h-full my-auto">
      <div className="container flex flex-col items-center">
        ...
        <div className="flex justify-between space-x-20">
          ...
          <a href={`//instagram.com/${info.social.instagram}`} target='_blank' className="link" rel="noreferrer">
            Instagram
          </a>
        </div>
        <p className="mt-20">O si lo prefieres, también puedes enviarnos un WhatsApp</p>
        <a
          href={`//wa.me/${info.whatsapp}`}
          onClick={() => fbq('track', 'Contact')}
          target='_blank'
          className='button-secondary' rel="noreferrer"
        >
